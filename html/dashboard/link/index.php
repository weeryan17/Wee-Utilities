	  	...
	  	<div class="container">
		      ...
		      <form class="form-login">
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" placeholder="Minecraft Email" autofocus>
		            <br>
		            <input type="password" class="form-control" placeholder="Minecraft Password">
		            <br>
		            <button class="btn btn-theme btn-block" href="index.html" type="submit"><i class="fa fa-lock"></i> SIGN IN</button>
		            
		            <div class="registration">
		                Forgot Minecraft Password?<br/>
		                <a class="" href="https://account.mojang.com/password">
