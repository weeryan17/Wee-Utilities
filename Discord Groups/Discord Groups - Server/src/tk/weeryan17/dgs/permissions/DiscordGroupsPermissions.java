package tk.weeryan17.dgs.permissions;
...
public class DiscordGroupsPermissions {
	...
	private static String[] allPerms = { "dg", "dg.server", "dg.server.generate", "dg.server.manage", "dg.server.stats",
			"dg.server.web", "dg.perm", "dg.perm.add", "dg.perm.remove", "dg.perm.group", "dg.perm.group.add",
			"dg.perm.group.remove", "dg.perm.group.modify" };
	...
	/**
	 * If the perm ends in a * then this get's all the perms that that star
	 * contains.
	 * 
	 ...
	 * 
	 * @param perm
	 *            The perm to get recursive perms from.
